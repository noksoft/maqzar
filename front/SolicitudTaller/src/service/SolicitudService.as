package service
{
	...
	public class SolicitudService
	{
		...
		public function SolicitudService()
		{
			...
			proveedorRemote.endpoint = NOKConstants.SERVICE_DESTINATION_PROVEEDOR;
			proveedorRemote.showBusyCursor = true;
			
			provedoresRemote.endpoint = NOKConstants.SERVICE_DESTINATION_PROVEEDORES;
			provedoresRemote.showBusyCursor = true;
		}
		...
		public function getProveedores(vo:ProveedorVO):AsyncToken{
			Alert.show("Service Proveedor");
			return proveedorRemote.catProveedor(vo);
		}
		
		public function findProveedores(vo:ProveedorVO):AsyncToken{
			return provedoresRemote.catProveedor(vo);
		}
	}
}